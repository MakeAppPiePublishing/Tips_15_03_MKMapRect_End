...
//
//
//  A simple example of using JSON data in an application using Codable for SwiftUI models
//
import Foundation
...
let data = """
{"items":[
    {"id":0,"name":"Margherita","latitude":40.836702,"longitude":14.246805,"history":"Street Food Nationalized - The legend goes that King Umberto and Queen Margherita of Italy got tired of the royal food, which was always French. Looking for both something new and something Italian, while in Naples they ordered a local pizzeria to make them pizza, which was up until then considered a food for the poor. The Queen loved a pizza of tomatoes, fresh mozzarella, and basil so much the restaurant named the pizza after her. That the pizza was the colors of the Italian flag may not be a coincidence. To this day, to sell a true Neapolitan pizza, you must be certified by an association of pizza restaurants in Naples for the process and for the quality of ingredients."},
    {"id":1,"name":"Huli Chicken", "latitude":21.664477,"longitude":-157.927428,"history":"In a completely fictitious Hawaii, on the island of Oahu, some friends got together to make pizzas, island style. They were often hungry after a good wave or two and wanted somewhere good to go that didn't look and taste mainland, especially Canadian. They took street foods and traditional pizzas from around the world to create a new pizza experience. In Hawaiian, hull means turn, which is a reference to the manual barbecue and rotisserie method of cooking huli chicken in teriyaki sauce blends."},
    {"id":2,"name":"Quattro Formaggi","latitude":41.895283,"longitude":12.497527,"history":"With the respectability of the Margherita pizza, other varieties began to spring up all over Italy. One common favorite is a quattro formaggi, a blend of melted cheeses. The best cheeses are often found in Rome, since the Neapolitans don't think it's authentic enough for them. "},
    ...
    {"id":4,"name":"Big Island","latitude":40.731627,"longitude":-74.003410,"history":"Calzones started in Naples as smaller pizzas you could eat while walking since, in Italy, they didn't serve slices, but rather, whole pizzas. In the early 20th century, John Sasso, of John's of Bleeker street in New York, started making huge sharable calzones you could only eat at the table."},
    ...
    {"id":7,"name":"Chicago Deep Dish","latitude":41.892235,"longitude":-87.627195,"history":"In 1943, Ike Sewell changed the crust from the thin flatbread to a deep pan, adding traditional Italian and New York ingredients. Sewell and his cook, and eventual manager, Rudy Malnati added a layer of sausage to the pan. Some believe the longer cooking time of 20 to 45 minutes of the deep dish meant more beverage consumption, and a higher profit for the restaurant. Deep dish pizza caught on in Chicago, with many competitors in the area. With the 2 inches of deeper pizza crust, the order of ingredients can change between competitors, with a crust ranging in texture from cracker-like to bread-like, and the cheese on top or on the sauce on top."},
    {"id":8,"name":"BBQ Chicken","latitude":34.064516,"longitude":-118.399334,"history":"Two Los Angeles Attorneys, Larry Flax and Rick Rosenfeld, were so entranced by Spago's pizza chef Ed LaDou’s pizzas that they started a casual dining restaurant with some of LaDou’s creations, including a new one of barbecue sauce and chicken. The restaurant was so successful, it became a chain throughout North America, South America, and Asia, popularizing non-Italian and often Asian, ingredients in pizza. A national food of Italy becomes a uniquely American food all over the world. Suspiciously, there are no locations in Europe."},
    {"id":9,"name":"Hawaiian","latitude":42.405825,"longitude": -82.186033, "history":"The so-called Hawaiian pizza is not Hawaiian: it's a Canadian treasure. Greek immigrant to Canada, Sam Panopoulos added canned pineapple and Canadian bacon to a pizza in his small restaurant in Chatham, Ontario. This is one of the earliest pizzas without traditional Italian ingredients. As late as 2017, a few months before the death of Panopoulos, this was controversial, with purists angry about pineapple on a pizza. Iceland’s president started a near diplomatic incident between Canada and Iceland with a statement that he would make pineapple on pizza illegal if he had the power to."}
]}
""".data(using: .utf8)!
